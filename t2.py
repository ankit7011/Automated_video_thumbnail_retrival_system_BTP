...
def pi_score_nonchar(groups, img_to_clust):
...
def predict_nochar():
    ...
    pi_scores = pi_score_nonchar(groups, img_to_clust)
    li_scores = li_score()
...
frames, faces, no_char = basic(video_path, num_frames)

paths_char = predict()
paths_nochar = predict_nochar()
